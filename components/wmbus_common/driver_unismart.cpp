...
Driver::Driver(MeterInfo &mi, DriverInfo &di)
  ...
  addStringFieldWithExtractor("total_date_time",
  ...
  addNumericFieldWithExtractor(
      "total", "The total gas consumption recorded by this meter.",
  ...
  addNumericFieldWithExtractor("target",
                               "The total gas consumption recorded by this "
                               "meter at the beginning of this month.",
  ...
  addStringFieldWithExtractor("version", "Model version.",
                              DEFAULT_PRINT_PROPERTIES,
                              FieldMatcher::build()
                                  .set(MeasurementType::Instantaneous)
                                  .set(VIFRange::ModelVersion));

  addStringFieldWithExtractor("supplier_info", "Supplier info?",
                              DEFAULT_PRINT_PROPERTIES,
                              FieldMatcher::build()
                                  .set(MeasurementType::Instantaneous)
  ...
  addStringFieldWithExtractor("meter_timestamp",
  ...
  addNumericFieldWithExtractor("battery", "Remaining battery life in days.",
...
// {"media":"gas","meter":"unismart","name":"GasMeter","id":"00043094","fabrication_no":"03162296","status":"STATUS_FLAGS_CF0","other":"OTHER_FLAGS_14","total_date_time":"2021-09-15
// 13:18","total_m3":917,"target_date_time":"2021-09-01
// 06:00","target_m3":911.32,"version":"
